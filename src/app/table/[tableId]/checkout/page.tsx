...
/>
      ...
      <div className="w-full max-w-xl bg-white/5 backdrop-blur-md rounded-2xl p-6 shadow-[0_0_40px_8px_rgba(255,210,143,0.2)] ring-1 ring-[#FFD28F]/30 space-y-4 animate-fade-in-up">
        {(isEvenSplit || filteredItems.length > 0) ? (
          <>
            {(isEvenSplit ? items : filteredItems).map((item) => {
          ...
          <div className="w-full text-center border border-white/10 rounded-xl p-6 text-white/60 font-serif italic">
